...
if ( ! -e single_echo_eg_cmplx.nii.gz || $force == 1 ) then
   x_epi_recon meas_MID00121_FID231460_pulseq.dat \
               single_echo_rs.json \
               single_echo -n_avg 32 -anat mag.nii.gz \
               -ref_info meas_MID00125_FID231464_pulseq.dat single_echo_rs_ref.json \
               -complex -k_coord single_echo_rs_kspace.npy
   set force = 1
endif
if ($? == 1) exit
